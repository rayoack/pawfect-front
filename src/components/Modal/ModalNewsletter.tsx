                ...
                >
                    <div className="main-content flex rounded-[20px] overflow-hidden w-full">
                        <div
                            ...
                            <div className="text-xs font-semibold uppercase text-center">Oferta Especial</div>
                            <div
                                className="lg:text-[70px] text-4xl lg:leading-[78px] leading-[42px] font-bold uppercase text-center">
                                Super<br />Promo</div>
                            <div className="text-button-uppercase text-center">Novos clientes economizam <span
                                className="text-red">30%</span>
                                com o codigo</div>
                            <div className="text-button-uppercase text-red bg-white py-2 px-4 rounded-lg">PAWFECT30</div>
                            <div className="button-main w-fit bg-black text-white hover:bg-white uppercase">Copiar Codigo
                            </div>
                        </div>
                        <div className="right lg:w-1/2 sm:w-3/5 w-full bg-white sm:pt-10 sm:pl-10 max-sm:p-6 relative">
                            ...
                            <div className="heading5 pb-5">Voce Tambem Pode Gostar</div>
                                            ...
                                            >
                                                ...
                                                <div className=''>
                                                    ...
                                                    <div className="flex items-center gap-2 mt-2">
                                                        <div className="product-price text-title">R${item.price},00</div>
                                                        <div className="product-origin-price text-title text-secondary2">
                                                            <del>R${item.originPrice},00</del>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
